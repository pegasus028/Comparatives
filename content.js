    ...
    },
    {
      ...
      items: [
        ...
        { id: 's8l3-02', type: 'spot', tag: 'register', level: 'C1',
          ...
          answer: 5, fix: 'add "than the units it replaced"',
          why: 'A dangling comparative. Grammatical, but with no standard it cannot be checked — the classic Task Response weakness.' },
